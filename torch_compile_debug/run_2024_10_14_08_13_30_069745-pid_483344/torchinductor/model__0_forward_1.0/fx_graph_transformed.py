class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[18432, 3072]", primals_2: "f16[18432]", primals_3: "f16[18432, 3072]", primals_4: "f16[18432]", primals_5: "f16[9216, 3072]", primals_6: "f16[9216]", primals_7: "f16[9216, 3072]", primals_8: "f16[9216]", primals_9: "f16[10, 3072]", primals_10: "f16[10, 4080, 3072]", primals_11: "f16[10, 256, 3072]"):
        ...
        mm_default_1: "f16[10, 18432]" = torch.ops.aten.mm.default(convert_element_type_1, permute);  permute = None
        add_tensor_1: "f16[10, 18432]" = torch.ops.aten.add.Tensor(mm_default_1, primals_2);  mm_default_1 = primals_2 = None
        
        # File: /home/myeongjun/workspace/flux_triton/src/flux/modules/layers_qkv.py:154 in forward, code: out = self.lin(nn.functional.silu(vec))[:, None, :].chunk(self.multiplier, dim=-1)
        unsqueeze: "f16[10, 1, 18432]" = torch.ops.aten.unsqueeze.default(add_tensor_1, 1);  add_tensor_1 = None
        ...
        # No stacktrace found for following nodes
        mm_default: "f16[10, 18432]" = torch.ops.aten.mm.default(convert_element_type_1, permute_1);  permute_1 = None
        add_tensor: "f16[10, 18432]" = torch.ops.aten.add.Tensor(mm_default, primals_4);  mm_default = primals_4 = None
        
        # File: /home/myeongjun/workspace/flux_triton/src/flux/modules/layers_qkv.py:154 in forward, code: out = self.lin(nn.functional.silu(vec))[:, None, :].chunk(self.multiplier, dim=-1)
        unsqueeze_1: "f16[10, 1, 18432]" = torch.ops.aten.unsqueeze.default(add_tensor, 1);  add_tensor = None
        ...
        view: "f16[40800, 3072]" = torch.ops.aten.reshape.default(add_1, [40800, 3072]);  add_1 = None
        ...
        view_1: "f16[10, 4080, 9216]" = torch.ops.aten.reshape.default(addmm_2, [10, 4080, 9216]);  addmm_2 = None
        ...
        view_2: "f16[2560, 3072]" = torch.ops.aten.reshape.default(add_3, [2560, 3072]);  add_3 = None
        ...
        view_3: "f16[10, 256, 9216]" = torch.ops.aten.reshape.default(addmm_3, [10, 256, 9216]);  addmm_3 = None
        
        # File: /home/myeongjun/workspace/flux_triton/src/flux/modules/layers_qkv.py:239 in forward, code: img_q, img_k, img_v = rearrange(
        view_4: "f16[10, 4080, 3, 24, 128]" = torch.ops.aten.reshape.default(view_1, [10, 4080, 3, 24, 128]);  view_1 = None
        ...
        view_5: "f16[10, 256, 3, 24, 128]" = torch.ops.aten.reshape.default(view_3, [10, 256, 3, 24, 128]);  view_3 = None
